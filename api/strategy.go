...
// handleGetOptimizedStrategyConfig Get optimized strategy configuration template (v2.0)
func (s *Server) handleGetOptimizedStrategyConfig(c *gin.Context) {
	// Get language from query parameter, default to "en"
	lang := c.Query("lang")
	if lang != "zh" {
		lang = "en"
	...
	// Return optimized configuration with i18n support
