...
func (s *BacktestStore) SaveTradeAIAnalysis(runID string, tradeID int64, analysis *TradeAnalysis) error {
...
func (s *BacktestStore) GetTradeAIAnalysis(runID string, tradeID int64) (*TradeAnalysis, error) {
